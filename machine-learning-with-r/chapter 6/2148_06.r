...
launch <- read.csv("D:/R_Workspace/machine-learning-with-r/chapter 6/challenger.csv")
...
insurance <- read.csv("D:/R_Workspace/machine-learning-with-r/chapter 6/insurance.csv", stringsAsFactors = TRUE)
str(insurance)
